...
//            entidad.setObjLineaProduccion(new entLineaProduccion(2));//1,2,3
//            entidad.setObjEnvase(new entEnvase(4));//1,4
//            entidad.setObjCategoria(new entCategoria(3));//1,2,3,4
//            entidad.setObjLote(new entLote(4));   //2,3,4,5,6        
//            entidad.setObjCalibre(new entCalibre(2));//1,2            
//            entidad.setObjColor(new entColor(2));//1,2
//            entidad.setEstado(0);
//            entidad.setFecha_produccion(fecha);
