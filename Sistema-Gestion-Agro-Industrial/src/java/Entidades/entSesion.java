...
public class entSesion {
    ...
    private entEmbarque objEmbarque;
    ...
    public entEmbarque getObjEmbarque() {
        return objEmbarque;
    }

    public void setObjEmbarque(entEmbarque objEmbarque) {
        this.objEmbarque = objEmbarque;
    }
