...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(41==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
{
     $.ajax({
        url: 'operaciones/direccion_llegada/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
 ...
 function getReporte()
{
     window.location='operaciones/direccion_llegada/reporte.jsp';
 };
					...
					errorPlacement: function(error, element) {
						$(element).closest('div').append(error);
                                    ...
                                    function clear_form() {
                                          ...
                                          $('#txtDireccion').val("");                                        
                                          $("#IdDireccionLlegada").val("0");  
                                     
                                           
                                      };
                                       function edit_form(id,nombre,estado) {
                                            $('#txtDireccion').val(nombre);
                                            $('#IdDireccionLlegada').val(id);
