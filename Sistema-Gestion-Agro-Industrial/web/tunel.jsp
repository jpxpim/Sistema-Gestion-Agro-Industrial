...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(67==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
                                                                      ...
                                                                      <form  method="get" id="reg_form">
                                                                          <div class="location_add_form well">
                                                                            <div class="formSep">
                                                                                    ...
                                                                                    <div class="input-prepend">
                                                                                    <label>Posición en X</label>
                                                                                    <input type="text" class="span10" id="txtPosX"  name="txtPosX" />
                                                                                     </div>  
                                                                                     <div class="input-prepend">
                                                                                    <label>Posición en Y</label>
                                                                                    <input type="text" class="span10" id="txtPosY"  name="txtPosY" />
                                                                                     </div>  
                                                                                    <div class="input-prepend">
                                                                                    <label>Posición en H</label>
                                                                                    <input type="text" class="span10" id="txtPosH"  name="txtPosH" />
                                                                                     </div>  
                                                                                     <div class="input-prepend">
                                                                                    <label>Estado</label>
                                                                                ...
                                                                                <input type="hidden" id="IdTunel"  name="IdTunel" value="0" />
...
{
     $.ajax({
        url: 'operaciones/tunel/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
 ...
 function getReporte()
{
     window.location='operaciones/tunel/reporte.jsp';
 };
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                       $("#abrirCarga").click();
                                                    var url = "operaciones/tunel/insert.jsp"; 
					...
					rules: {
						txtNombre: { required: true, minlength: 3 },
                                                ...
                                                txtPosX: { required: true, digits: true },
                                                txtPosY: { required: true, digits: true },
                                                txtPosH: { required: true, digits: true },
					...
					errorPlacement: function(error, element) {
						$(element).closest('div').append(error);
                                    ...
                                    function clear_form() {
                                       ...
                                       function edit_form(id,nombre,descripcion,px,py,ph,estado) {
