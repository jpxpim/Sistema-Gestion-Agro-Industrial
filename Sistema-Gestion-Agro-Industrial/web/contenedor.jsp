...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(79==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
                                                                      ...
                                                                      <form  method="get" id="reg_form">
                                                                          <div class="location_add_form well">
                                                                            <div class="formSep">
                                                                                ...
                                                                                <input type="hidden" id="IdContenedor"  name="IdContenedor" value="0" />
...
{
     $.ajax({
        url: 'operaciones/contenedor/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
 ...
 function getReporte()
{
     window.location='operaciones/contenedor/reporte.jsp';
 };
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                       $("#abrirCarga").click();
                                                    var url = "operaciones/contenedor/insert.jsp"; 
					...
					errorPlacement: function(error, element) {
						$(element).closest('div').append(error);
                                    ...
                                    function clear_form() {
                                       ...
                                       function edit_form(id,nombre,posx,posy,estado) {
