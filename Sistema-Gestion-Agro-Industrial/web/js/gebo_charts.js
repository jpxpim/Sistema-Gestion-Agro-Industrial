/* [ ---- Gebo Admin Panel - charts ---- ] */
    ...
    gebo_charts = {
        fl_a : function() {
            ...
            // you can use one of the color scheme for other charts (just copy color scheme to other chart option)
            // colors: [ "#b4dbeb", "#8cc7e0", "#..." ]
            elem.parent().find(".chart_colors input").click(function (e) {
                $(this).attr('checked','checked');
                var thisColor = $(this).val();
                if(thisColor == 'ch_blue'){
                    colors = [ "#b4dbeb", "#8cc7e0", "#64b4d5", "#3ca0ca", "#2d83a6", "#22637e", "#174356", "#0c242e" ];
                } else if(thisColor == 'ch_green'){
                    colors = [ "#d7efc1", "#bce499", "#a2d971", "#88ce49", "#6eb430", "#568c25", "#3d641b", "#243b10" ];
                } else if(thisColor == 'ch_brown'){
		...
		fl_b : function() {
            ...
            elem.on('multihighlighted', function(event, position, items){
                ...
                if(event.isTrigger) {
                    ...
                    var date_formated = moment(date[0]).format("MMM Do 'YY");
