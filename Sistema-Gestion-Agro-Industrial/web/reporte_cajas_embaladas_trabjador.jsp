...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(87==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
function tabla(operacion)
{
 ...
 function getReporte()
{
     window.location='operaciones/reporte/reporte_cajas_embaladas_trabjador.jsp?operacion='+$("select#cbOperacion").val(); ;
 };
