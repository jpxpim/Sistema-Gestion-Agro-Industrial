...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(13==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
											  ...
											  <form  method="get" id="reg_form">
												...
												<div class="formSep">
													...
													<label class="radio inline">
                                                                                                    ...
                                                                                                    <input type="hidden" id="IdSubSector"  name="IdSubSector" value="0" />
...
{
     $.ajax({
        url: 'operaciones/sub_sector/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
...
{
     $.ajax({
        url: 'operaciones/sector/list_combo.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#cbSector').html(data);
        },
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                             $("#abrirCarga").click();
                                                    var url = "operaciones/sub_sector/insert.jsp"; 
                                    ...
                                    function clear_form() {
                                       ...
                                       function edit_form(id,nombre,descripcion,estado,grower,idCultivo,mCultivo,codigo) {
                                            ...
                                            if(buscaCombo(idCultivo))
                                               $("select#cbSector").val(idCultivo); 
                                            else
                                            {
                                                comboId=idCultivo;
                                                $("#cbSector").append('<option value='+idCultivo+'>'+mCultivo+'</option>');
                                                $("select#cbSector").val(idCultivo); 
                                            }
