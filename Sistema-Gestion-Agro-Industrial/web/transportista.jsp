...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(40==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
{
     $.ajax({
        url: 'operaciones/transportista/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
 ...
 function getReporte()
{
     window.location='operaciones/transportista/reporte.jsp';
 };
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                       $("#abrirCarga").click();
                                                    var url = "operaciones/transportista/insert.jsp"; 
					...
					rules: {
						txtRazon: { required: true, minlength: 3 },
                                                txtRuc: { required: true, minlength: 11, maxlength: 11,digits:true},
					...
					errorPlacement: function(error, element) {
						$(element).closest('div').append(error);
                                    ...
                                    function clear_form() {
                                          ...
                                          $("#IdTransportista").val("0");  
                                     
                                           
                                      };
                                       function edit_form(id,nombre,peso,estado) {
                                            $('#txtRazon').val(nombre);
                                            $('#txtRuc').val(peso);
