...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(10==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
											  ...
											  <form  method="get" id="reg_form">
												...
												<div class="formSep">
													...
													<label class="radio inline">
                                                                                                    ...
                                                                                                    <input type="hidden" id="IdEdadCultivo"  name="IdEdadCultivo" value="0" />
...
{
     $.ajax({
        url: 'operaciones/edad_cultivo/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
   ...
   function getReporte()
{
     window.location='operaciones/edad_cultivo/reporte.jsp';
 };                             
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                             $("#abrirCarga").click();
                                                    var url = "operaciones/edad_cultivo/insert.jsp"; 
