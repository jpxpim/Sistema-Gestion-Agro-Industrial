...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(34==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
function editar(id,tipo)
{
     $("#abrirCarga").click();
     $.ajax({
            url: 'operaciones/raleo/buscar.jsp?id='+id+"&tipo="+tipo,
            type: 'POST',
            success: function () {  
                if(tipo==0)
                {
                    $.ajax({
                        url: 'operaciones/raleo/list_tabla_temp.jsp?posicion=0',
                        type: 'POST',
                        success: function (data) {     
                                 $('#frane').html(data);
                        },
                ...
                {
                    $.ajax({
                        url: 'operaciones/raleo/ver_list_tabla_temp.jsp',
                        type: 'POST',
                        success: function (data) {     
                                 $('#frane').html(data);
                        },
...
function tablaTemp(pos)
{
    $("#abrirCarga").click(); 
     $.ajax({
        url: 'operaciones/raleo/list_tabla_temp.jsp?posicion='+pos,
        type: 'POST',
        success: function (data) {     
                 $('#frane').html(data);
        },
 ...
 function tabla()
{
     ...
     $.ajax({
        url: 'operaciones/raleo/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#frane').html(data);
