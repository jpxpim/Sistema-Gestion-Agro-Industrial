...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(32==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
function editar(id)
{
     $("#myModal").modal('show'); 
     $.ajax({
            url: 'operaciones/poda/buscar.jsp?id='+id,
            type: 'POST',
            success: function () {  
                 $.ajax({
                        url: 'operaciones/poda/list_tabla_temp.jsp?posicion=0',
                        type: 'POST',
                        success: function (data) {     
                                 $('#frane').html(data);
                        },
...
function tablaTemp(pos)
{
    $("#myModal").modal('show');  
     $.ajax({
        url: 'operaciones/poda/list_tabla_temp.jsp?posicion='+pos,
        type: 'POST',
        success: function (data) {     
                 $('#frane').html(data);
        },
 ...
 function tabla()
{
     ...
     $.ajax({
        url: 'operaciones/poda/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#frane').html(data);
                 $('#myModal').modal('hide');
