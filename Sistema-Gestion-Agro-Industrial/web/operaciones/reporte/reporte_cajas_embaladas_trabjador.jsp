...
if(request.getParameter("operacion") != null && request.getParameter("operacion") != "")
{
   ...
   if(operacion==1)
        nombre="REPORTE CAJAS EMBALADAS POR FECHAS DEL "+inicio+" AL "+fin+"";
    else  if(operacion==2)
        nombre="REPORTE CAJAS EMBALADAS DE ULTIMO DÍA DE RECEPCIÓN CERRADO";
    else  if(operacion==3)
        nombre="REPORTE CAJAS EMBALADAS DE ULTIMO DÍA DE RECEPCIÓN ABIERTO";
    else  if(operacion==4)
        nombre="REPORTE CAJAS EMBALADAS DE TODOS LOS DÍAS DE RECEPCIÓN CERRADOS";
    else  if(operacion==5)
        nombre="REPORTE CAJAS EMBALADAS DE TODOS LOS DÍAS DE RECEPCIÓN";
    
    response.setHeader("Content-Disposition", "attachment; filename=\"REPORTE "+nombre+" "+e.format(new Date())+".xls\"");
    
    
List<entReporte> list=clsGestor.listarCajasEmbaladasXTrabajadorReporte(operacion,inicio,fin);
if(list!=null)   
{
...
<table border="1">
    ...
    <tr>
                    ...
                    <td><center><strong>Cajas Embaladas</strong></center></td>
