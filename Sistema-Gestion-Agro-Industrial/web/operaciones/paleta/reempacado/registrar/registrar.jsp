        ...
        else
        {
            ...
            else
            {
                smoke.confirm('Desea Grabar Paleta',function(e){
                    if (e){
                        var url = "operaciones/paleta/reempacado/registrar/insert.jsp"; 
                        $.ajax({
                        type: "POST",
                        url: url,
...
var producto= {
     'entidad': [ 
    <%
    List<entProductoTerminado> listProductoTerminado = clsGestor.ListarReempacadoProductoTerminado();
...
{
    $.ajax({
            url: 'operaciones/producto_terminado/data_producto_reempacado.jsp',
            type: 'POST',
            success: function (data) {     
