...
if(objSession!=null)
{
    entDiaRecepcion objDiaRecepcion=clsGestor.ultimoDiaRecepcion();
    entLineaProduccion objLineaProduccion = clsGestor.buscarReempaqueLineaProduccion();
    int size=0;

if(objDiaRecepcion!=null && objLineaProduccion!=null)
{
%>
<div id="frame">
 <div class="row-fluid">
                                                            ...
                                                            <div class="span12">
                                                                          ...
                                                                          <div class="location_add_form well">
                                                                            <div class="formSep">
                                                                                    ...
                                                                                    <input type="hidden" id="reempaque"  name="reempaque"  value="1" /> 
                                                                                    <input type="hidden" id="idDiaRecepcion"  name="idDiaRecepcion"  value="<%=objDiaRecepcion.getId_dia_recepcion()%>" />
                                                                                    <input type="hidden" id="cbLineaProduccion"  name="cbLineaProduccion"  value="<%=objLineaProduccion.getId_linea_produccion()%>" /> 
...
function tabla()
{
        ...
        $.ajax({
            url: 'operaciones/producto_terminado/list_tabla_reempaque.jsp?id=<%=objLineaProduccion.getId_linea_produccion()%>',
            type: 'POST',
...
<%
}else out.print("<center><H3>No se Econtro un Día de Producción </H3></center>");}%>  
