...
List<entLineaNaviera> list=clsGestor.ListarLineaNaviera(false);
if(list!=null)
{%>
<%response.setHeader("Content-Disposition", "attachment; filename=\"Reporte Linea Naviera "+e.format(new Date())+".xls\"");%>
