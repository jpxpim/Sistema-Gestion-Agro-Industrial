...
<table id="lista" class="table table-striped location_table">
    ...
    %>
        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0)" onclick="edit_form(<%=entidad.getId_linea_naviera()%>,'<%=entidad.getNombre()%>','<%=entidad.getEstado()%>')" class="comp_edit btn btn-primary btn-mini">Editar</a>
