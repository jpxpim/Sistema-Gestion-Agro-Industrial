...
<div id="producto_terminado_linea">
<%
...
$(function () { 
	...
	// Setup the placeholder reference
            var elem = $('#cardio_producto_terminado_linea');
			...
			cardio_producto_terminado_linea_plot = $.plot(elem,
			    [
            ...
            elem.on('multihighlighted', function(event, position, items){
                ...
                if(event.isTrigger) {
                    ...
                    var date = cardio_producto_terminado_linea_plot.getData()[0].data[items[0].dataIndex];
                    // formated by Moment.js
                    var date_formated = moment(date[0]).format('MMMM D, h:mm:ss a');
                    
                    var oilprices_label = cardio_producto_terminado_linea_plot.getData()[0].label,
                        oilprices_val = cardio_producto_terminado_linea_plot.getData()[0].data[items[0].dataIndex];
