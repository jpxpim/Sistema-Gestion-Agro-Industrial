...
<div id="producto_terminado_calibre">
<%
if(request.getParameter("id") != null && request.getParameter("id") != "")    
{
List<entProductoTerminado> list=clsGestor.GraficoCalibredxLineaProduccionProductoTerminado(Integer.parseInt(request.getParameter("id"))); 
if(list!=null)
{
int size=list.size();
%>
<div id="barras_producto_terminado_calibre" style="height:200px;width:90%;margin:15px auto 0"></div>
...
var optioms ={
    ...
    $.plot($("#barras_producto_terminado_calibre"), [data],optioms );
    
     $("#barras_producto_terminado_calibre").qtip({
                prerender: true,
            ...
            // Bind the plot hover
            $("#barras_producto_terminado_calibre").on('plothover', function(event, coords, item) {
