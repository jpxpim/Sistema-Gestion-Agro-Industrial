...
<%
 if(request.getParameter("s1") != null && request.getParameter("s1") != "" &&
    ...
    request.getParameter("s4") != null && request.getParameter("s4") != "")
{

%>
<div id="pre_poda_diametro" style="height:150px;width:90%;margin:15px auto 0"></div>

<script type="text/javascript">
$(function () { 
    var data = [
    <%out.print("{label: '<7', data: "+request.getParameter("s1")+"},");
    out.print("{label: '7-9', data: "+request.getParameter("s2")+"},");
    out.print("{label: '10-12', data: "+request.getParameter("s3")+"},");
    out.print("{label: '>12', data: "+request.getParameter("s4")+"}");%>
    ...
    $.plot($("#pre_poda_diametro"), data, options);  
    
       $("#pre_poda_diametro").qtip({
                prerender: true,
            ...
            // Bind the plot hover
            $("#pre_poda_diametro").on('plothover', function(event, pos, obj) {
