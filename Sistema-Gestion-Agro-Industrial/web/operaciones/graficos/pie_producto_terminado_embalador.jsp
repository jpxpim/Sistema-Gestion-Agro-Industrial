...
<div id="producto_terminado_embalador">
<%
List<entProductoTerminado> list=clsGestor.GraficoEmbaladorProductoTerminado(); 
if(list!=null)
{
int size=list.size();
%>
...
$(function () { 
    ...
    $.plot($("#pie_producto_terminado_embalador"), data, options);  
    
       $("#pie_producto_terminado_embalador").qtip({
                prerender: true,
            ...
            // Bind the plot hover
            $("#pie_producto_terminado_embalador").on('plothover', function(event, pos, obj) {
