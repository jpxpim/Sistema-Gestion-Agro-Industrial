...
<div id="producto_terminado_envase">
<%
if(request.getParameter("id") != null && request.getParameter("id") != "")    
{
List<entProductoTerminado> list=clsGestor.GraficoEnvasexLineaProduccionProduccionProductoTerminado(Integer.parseInt(request.getParameter("id"))); 
if(list!=null)
{
int size=list.size();
%>
...
var optioms ={
    ...
    $.plot($("#barras_producto_terminado_envase"), [data],optioms );
    
     $("#barras_producto_terminado_envase").qtip({
                prerender: true,
            ...
            // Bind the plot hover
            $("#barras_producto_terminado_envase").on('plothover', function(event, coords, item) {
