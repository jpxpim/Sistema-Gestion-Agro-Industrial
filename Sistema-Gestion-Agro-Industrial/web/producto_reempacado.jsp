...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(91==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
{    $('#frame').html('<center><h3 id="frame"><img src="img/ajax-loader.gif" alt="" /> Espere un Momento ...</h3></center>');
    $.ajax({
        url: 'operaciones/producto_terminado/gestion_producto_reempacado.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#frame').html(data);
        },
