...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(77==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
                                                                      ...
                                                                      <form  method="get" id="reg_form">
                                                                          <div class="location_add_form well">
                                                                            <div class="formSep">
                                                                                    ...
                                                                                    <label>Nombre</label>
                                                                                     <textarea cols="30" rows="2" class="span10" id="txtNombre" name="txtNombre" ></textarea>                                                                                   
                                                                                    </div> 
                                                                                    <div class="input-prepend">
                                                                                    <label>RUC</label>
                                                                                    ...
                                                                                    <label>Dirección</label>
                                                                                     <textarea cols="30" rows="4" class="span10" id="txtDireccion" name="txtDireccion" ></textarea>                                                                                   
                                                                                    </div>  
                                                                                     <div class="input-prepend">
                                                                                    <label>Estado</label>
...
{
     $.ajax({
        url: 'operaciones/cliente/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
 ...
 function getReporte()
{
     window.location='operaciones/cliente/reporte.jsp';
 };
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                       $("#myModal").modal('show'); 
                                                    var url = "operaciones/cliente/insert.jsp"; 
					...
					rules: {
						txtNombre: { required: true, minlength: 3 },
                                                txtRuc: { required: true, rangelength: [11,11],digits:true },
                                                txtDireccion: { required: true, minlength: 2 },
					...
					errorPlacement: function(error, element) {
						$(element).closest('div').append(error);
                                    ...
                                    function clear_form() {
                                       ...
                                       function edit_form(id,nombre,ruc,direccion,estado) {
