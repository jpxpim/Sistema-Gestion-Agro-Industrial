...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(88==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
{
    if(reporte)
     window.location='operaciones/reporte/reporte_cajas_seleccionador_trabajador.jsp?operacion=1&inicio='+$('#inicio').val()+'&fin='+$('#fin').val();
    else
        ...
        ignore: "input[type='text']:hidden",
            submitHandler: function() {      
                  ...
                  $('#tabla').html('<center id="tabla"><h3><img src="img/ajax-loader.gif" alt="" /> Espere un Momento ...</h3></center>');
                    ...
                    var url = "operaciones/reporte/cajas_seleccionador_trabjador.jsp"; 
                    $.ajax({
                           type: "POST",
                           url: url,
