...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(15==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
										...
										<div class="span12">
											  <form  method="get" id="reg_form">
												...
												<div class="formSep">
													...
													<input type="text" class="span10" id="txtERP"  name="txtERP" />
                                                                                                         </div>  
                                                                                                        <div class="input-prepend">
													...
													<label class="radio inline">
                                                                                                    ...
                                                                                                    <input type="hidden" id="IdProductor"  name="IdProductor" value="0" />
...
{
     $.ajax({
        url: 'operaciones/productor/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                   $("#abrirCarga").click();
                                                    var url = "operaciones/productor/insert.jsp"; 
					...
					rules: {
						txtNombre: { required: true, minlength: 3 },
                                                txtERP: { required: true, minlength: 3 },
					...
					errorPlacement: function(error, element) {
						$(element).closest('div').append(error);
                                    ...
                                    function clear_form() {
                                       ...
                                       function edit_form(id,nombre,erp,estado,codigo) {
