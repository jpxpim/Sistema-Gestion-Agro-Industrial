...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(14==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
											  ...
											  <form  method="get" id="reg_form">
												...
												<div class="formSep">
													...
													<label class="radio inline">
                                                                                                    ...
                                                                                                    <input type="hidden" id="IdTipodCultivo"  name="IdTipodCultivo" value="0" />
...
{
     $.ajax({
        url: 'operaciones/tipo_cultivo/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                $("#abrirCarga").click();
                                                    var url = "operaciones/tipo_cultivo/insert.jsp"; 
