...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(55==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
											  ...
											  <form  method="get" id="reg_form">
												...
												<div class="formSep">
													...
													<input type="text" class="span10" id="txtCodigo"  name="txtCodigo" />
                                                                                                         ...
                                                                                                         <div class="input-prepend">
													<label>Peso</label>
													<input type="text" class="span10" id="txtPeso"  name="txtPeso" />
                                                                                                         </div> 
                                                                                                        <div class="input-prepend">
													<label>Peso de Carga</label>
													<input type="text" class="span10" id="txtCarga"  name="txtCarga" />
                                                                                                         </div>   
                                                                                                        <div class="input-prepend">
													<label>Cantidad de Cajas por Paleta</label>
													<input type="text" class="span10" id="txtCajas"  name="txtCajas" />
                                                                                                         </div>   
                                                                                                        <div class="input-prepend">
													<label>Receta</label>
													...
													<label class="radio inline">
                                                                                                    ...
                                                                                                    <input type="hidden" id="IdEnvase"  name="IdEnvase" value="0" />
...
{
     $.ajax({
        url: 'operaciones/envase/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
   ...
   function getReporte()
{
     window.location='operaciones/envase/reporte.jsp';
 };
 function comboCultivo()
{
     $.ajax({
        url: 'operaciones/receta/list_combo.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#cbReceta').html(data);
        },
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                             $("#myModal").modal('show'); 
                                                    var url = "operaciones/envase/insert.jsp"; 
					...
					errorPlacement: function(error, element) {
						$(element).closest('div').append(error);
                                    ...
                                    function clear_form() {
                                            ...
                                            $('#txtPeso').val("");
                                            $('#txtCarga').val("");
                                            $("select#cbReceta").val('0'); 
                                            $('#txtCajas').val("");
                                            
                                            if(comboId>0)
                                              $("#cbReceta option[value='"+comboId+"']").remove();
                                           $("select#cbReceta").val(0);    
                                            $("#IdEnvase").val("0");  
                                           
                                      };

                                       function edit_form(id,nombre,codigo,peso,carga,cajas,idReceta,nReceta,estado) {
                                            ...
                                            if(buscaCombo(idReceta))
                                               $("select#cbReceta").val(idReceta); 
                                            else
                                            {
                                                comboId=idReceta;
                                                $("#cbReceta").append('<option value='+idReceta+'>'+nReceta+'</option>');
                                                $("select#cbReceta").val(idReceta); 
                                            }
