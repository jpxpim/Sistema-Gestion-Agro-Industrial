...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(12==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
											  ...
											  <form  method="get" id="reg_form">
												...
												<div class="formSep">
													...
													<label class="radio inline">
                                                                                                    ...
                                                                                                    <input type="hidden" id="IdSector"  name="IdSector" value="0" />
...
{
     $.ajax({
        url: 'operaciones/sector/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                   $("#abrirCarga").click();
                                                    var url = "operaciones/sector/insert.jsp"; 
