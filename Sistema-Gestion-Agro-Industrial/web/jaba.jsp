...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(44==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
                                                                      ...
                                                                      <form  method="get" id="reg_form">
                                                                          <div class="location_add_form well">
                                                                            <div class="formSep">
                                                                                ...
                                                                                <input type="hidden" id="IdJaba"  name="IdJaba" value="0" />
...
{
     $.ajax({
        url: 'operaciones/jaba/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
 ...
 function getReporte()
{
     window.location='operaciones/jaba/reporte.jsp';
 };
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                       $("#myModal").modal('show'); 
                                                    var url = "operaciones/jaba/insert.jsp"; 
