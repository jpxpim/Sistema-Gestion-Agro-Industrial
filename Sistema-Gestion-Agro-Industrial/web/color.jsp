...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(57==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
											  ...
											  <form  method="get" id="reg_form">
												...
												<div class="formSep">
													...
													<label class="radio inline">
                                                                                                    ...
                                                                                                    <input type="hidden" id="IdColor"  name="IdColor" value="0" />
...
{
     $.ajax({
        url: 'operaciones/color/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
   ...
   function getReporte()
{
     window.location='operaciones/color/reporte.jsp';
 };
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                             $("#abrirCarga").click();
                                                    var url = "operaciones/color/insert.jsp"; 
