...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(68==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
function registrar()
{
    $('#frame').html('<center id="frame"><h3><img src="img/ajax-loader.gif" alt="" /> Espere un Momento ...</h3></center>');
   
     $.ajax({
        url: 'operaciones/embarque/grabar/grabar.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#frame').html(data);
        },
