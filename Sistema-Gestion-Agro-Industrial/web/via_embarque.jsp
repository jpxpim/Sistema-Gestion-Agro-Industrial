...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(81==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
                                                                      ...
                                                                      <form  method="get" id="reg_form">
                                                                          <div class="location_add_form well">
                                                                            <div class="formSep">
                                                                                ...
                                                                                <input type="hidden" id="IdViaEmbarque"  name="IdViaEmbarque" value="0" />
...
{
     $.ajax({
        url: 'operaciones/via_embarque/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#tabla').html(data);
        },
 ...
 function getReporte()
{
     window.location='operaciones/via_embarque/reporte.jsp';
 };
				...
				$(document).ready(function() {
					...
					validClass: 'valid',
                                            submitHandler: function() {       
                                                       $("#myModal").modal('show'); 
                                                    var url = "operaciones/via_embarque/insert.jsp"; 
