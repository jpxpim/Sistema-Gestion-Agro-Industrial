...
if(objSession!=null)
{
    ...
    int posJ=objSession.getListModulos().get(objSession.getPosicion()).getList().size();
        ...
        {
            if(30==objSession.getListModulos().get(objSession.getPosicion()).getList().get(j).getControl_form())
            {
...
function editar(id,tipo)
{
     $("#abrirCarga").click();
     $.ajax({
            url: 'operaciones/pre_poda/buscar.jsp?id='+id+"&tipo="+tipo,
            type: 'POST',
            success: function () {  
                if(tipo==0)
                {
                    $.ajax({
                        url: 'operaciones/pre_poda/list_tabla_temp.jsp?posicion=0',
                        type: 'POST',
                        success: function (data) {     
                                 $('#frane').html(data);
                        },
                ...
                {
                    $.ajax({
                        url: 'operaciones/pre_poda/ver_list_tabla_temp.jsp',
                        type: 'POST',
                        success: function (data) {     
                                 $('#frane').html(data);
                        },
...
function tablaTemp(pos)
{
    $("#abrirCarga").click(); 
     $.ajax({
        url: 'operaciones/pre_poda/list_tabla_temp.jsp?posicion='+pos,
        type: 'POST',
        success: function (data) {     
                 $('#frane').html(data);
        },
 ...
 function tabla()
{
     ...
     $.ajax({
        url: 'operaciones/pre_poda/list_tabla.jsp',
        type: 'POST',
        success: function (data) {     
                 $('#frane').html(data);
